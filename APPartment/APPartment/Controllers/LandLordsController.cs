...
namespace APPartment.Controllers
{
    public class LandLordsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LandLordID,Name,LandLordEmail,Rating")] LandLord landLord)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LandLordID,Name,LandLordEmail,Rating")] LandLord landLord)
        {
