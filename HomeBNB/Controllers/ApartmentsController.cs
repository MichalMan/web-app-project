    ...
    public class ApartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            if (!String.IsNullOrEmpty(searchString)){
                apartments = apartments.Where(s => s.Address.Contains(searchString));
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ApartmentID,Address,Owner,Price,NumberOfRooms,Renovated,Description")] Apartment apartment)
        {
